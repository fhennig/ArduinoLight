...
public class ChannelContainerComponentController {
    ...
    void initialize() {
        ...
        _channelList.getItems().add(Model.getInstance().getChannelFactory().newChannel("TestChannel 1"));
        _channelList.getItems().add(Model.getInstance().getChannelFactory().newChannel("TestChannel 2"));
    }
}
